...
![Hero Image Placeholder](https://raw.githubusercontent.com/mohammedthansheer/mermaid-flow/main/assets/hero.png)
...
### Installation
1. Search for **Mermaid Flow** in the Obsidian Community Plugins browser.
2. Click **Install**, then **Enable**.

### How to Use
1. **Insert a New Diagram:**
   - Use the Ribbon icon (workflow icon).
   - Or use the command: `Mermaid Flow: Insert visual Mermaid diagram`.
2. **Edit an Existing Diagram:**
   - Click the "Edit" button that appears on top of any Mermaid block in Reading Mode or Live Preview.
   - Or place your cursor inside a `mermaid` code block and use the command: `Mermaid Flow: Edit Mermaid diagram visually`.
3. **Saving:**
